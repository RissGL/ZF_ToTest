...
namespace ZGameFramework.UIFramework
{
    ...
    public class PopupExampleWindowController:UIDemoWindowController
    {
        [SerializeField] 
        ...
        protected override void Awake() 
        {
            ...
            testButton.onClick.AddListener(UI_ShowPopup);
        }
        
        public void UI_ShowPopup() 
        {
            this.SendEvent<ShowConfirmationPopupEvent>(new ShowConfirmationPopupEvent(GetData()));
        }

        public ConfirmationPopupProperties GetData()
        {
