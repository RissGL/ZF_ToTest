...
namespace ZGameFramework.UIFramework
{
    ...
    public class ConfirmUIController:UIDemoWindowController<ConfirmationPopupProperties>
    {
    ...
    public class ConfirmationPopupProperties : WindowProperties
    {
        ...
        public void SetConfirmAndCancelAction(Action confirmAction, Action cancelAction)
        {
            ConfirmAction = confirmAction;
            CancelAction = cancelAction;
        }
